              ...
              {[
                {
                  ...
                  label: "Email",
                  value: "syedfayequeuddinyusuf@gmail.com",
                },
                {
                  icon: Mail,
                  href: "mailto:syedyusuf8448@gmail.com",
                  label: "Email",
                  value: "syedyusuf8448@gmail.com",
                },
                {
                  icon: MapPin,
                  href: "https://maps.app.goo.gl/TrhcRkV6kWBguDts9",
                  label: "Location",
                  value: "New Delhi, IN",
                },
                {
                ...
                <AnimatedSection key={item.label} delay={i * 0.1}>
                  <a
                    ...
                    className="glass-card p-5 flex items-center gap-4 hover:glow transition-shadow duration-300 cursor-pointer"
                  >
